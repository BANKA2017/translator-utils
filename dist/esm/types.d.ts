...
export type Platform = 'google' | 'google_browser' | 'google_browser_v2' | 'microsoft' | 'microsoft_browser' | 'microsoft_tts' | 'microsoft_edge_tts' | 'sogou' | 'sogou_browser' | 'sogou_tts' | 'yandex' | 'yandex_browser' | 'baidu' | 'baidu_tts' | 'deepl' | 'watson';
